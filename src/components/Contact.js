const Contact = () => {
  return (
    <div id="contact" className="pt-64 min-h-screen">
      ...
      <p className="text-lg">Please connect with me about anything tech!</p>
      <p className="text-lg mb-6">
        I am open to any questions or if you simply want to chat and get to know
        me!
      </p>
      <a
        className="hoverButtons bg-lime-400 rounded-full px-4 py-2 lg:py-2.5 w-[35%] text-lg  text-center lg:text-lg lg:w-[16%] hover:bg-lime-600"
